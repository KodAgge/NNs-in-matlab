...
GDparams = [100, 0.005, 100];

% Run gradient decent
[Wstar, bstar] = MiniBatchGD(trainX, trainY, valX, valY, GDparams, W, b, lambda, 0.95);
...
function [Wstar, bstar] = MiniBatchGD(X, Y, valX, valY, GDparams, W, b, lambda, mu)
    % Extract parameters
    n_batch = GDparams(1);
    eta = GDparams(2);
    n_epochs = GDparams(3);
